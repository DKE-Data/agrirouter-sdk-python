...
_sym_db.RegisterEnumDescriptor(_LISTENDPOINTSQUERY_DIRECTION)
...
_LISTENDPOINTSQUERY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='technical_message_type', full_name='agrirouter.request.payload.account.ListEndpointsQuery.technical_message_type', index=0,
...
_LISTENDPOINTSQUERY.fields_by_name['direction'].enum_type = _LISTENDPOINTSQUERY_DIRECTION
_LISTENDPOINTSQUERY_DIRECTION.containing_type = _LISTENDPOINTSQUERY
DESCRIPTOR.message_types_by_name['ListEndpointsQuery'] = _LISTENDPOINTSQUERY
