...
class CloudOnboardParameters(MessageParameters):
    ...
    def __init__(self,
                 # List[EndpointRegistrationDetails] - must be defined in generated by by proto schemes,
                 # but they are not
                 onboarding_requests: list = None,
                 **kwargs
                 ):
        self.onboarding_requests = onboarding_requests if onboarding_requests else []
        super(CloudOnboardParameters, self).__init__(**kwargs)
...
class CloudOffboardParameters(MessageParameters):
    ...
    def __init__(self,
        ...
        super(CloudOffboardParameters, self).__init__(**kwargs)
