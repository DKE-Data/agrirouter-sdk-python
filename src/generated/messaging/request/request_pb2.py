...
_REQUESTENVELOPE_MODE = _descriptor.EnumDescriptor(
    name='Mode',
    full_name='src.request.RequestEnvelope.Mode',
    filename=None,
    file=DESCRIPTOR,
    create_key=_descriptor._internal_create_key,
    values=[
...
_REQUESTENVELOPE = _descriptor.Descriptor(
    ...
    full_name='src.request.RequestEnvelope',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name='application_message_id', full_name='src.request.RequestEnvelope.application_message_id',
            index=0,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='src.request.RequestEnvelope.application_message_seq_no', index=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
        _descriptor.FieldDescriptor(
            name='team_set_context_id', full_name='src.request.RequestEnvelope.team_set_context_id', index=3,
            ...
            serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
        _descriptor.FieldDescriptor(
            name='mode', full_name='src.request.RequestEnvelope.mode', index=4,
            ...
            serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
        _descriptor.FieldDescriptor(
            name='recipients', full_name='src.request.RequestEnvelope.recipients', index=5,
            ...
            serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
        _descriptor.FieldDescriptor(
            name='chunk_info', full_name='src.request.RequestEnvelope.chunk_info', index=6,
            ...
            serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
        _descriptor.FieldDescriptor(
            name='timestamp', full_name='src.request.RequestEnvelope.timestamp', index=7,
            ...
            serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
        _descriptor.FieldDescriptor(
            name='metadata', full_name='src.request.RequestEnvelope.metadata', index=8,
...
_REQUESTPAYLOADWRAPPER = _descriptor.Descriptor(
    ...
    full_name='src.request.RequestPayloadWrapper',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name='details', full_name='src.request.RequestPayloadWrapper.details', index=0,
...
RequestEnvelope = _reflection.GeneratedProtocolMessageType('RequestEnvelope', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:src.request.RequestEnvelope)
})
...
RequestPayloadWrapper = _reflection.GeneratedProtocolMessageType('RequestPayloadWrapper', (_message.Message,), {
    ...
    '__module__': 'messaging.request.request_pb2'
    # @@protoc_insertion_point(class_scope:src.request.RequestPayloadWrapper)
})
