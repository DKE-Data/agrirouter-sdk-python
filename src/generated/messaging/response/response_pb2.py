...
_RESPONSEENVELOPE_RESPONSEBODYTYPE = _descriptor.EnumDescriptor(
    ...
    full_name='src.response.ResponseEnvelope.ResponseBodyType',
    filename=None,
    file=DESCRIPTOR,
    create_key=_descriptor._internal_create_key,
    values=[
...
_RESPONSEENVELOPE = _descriptor.Descriptor(
    ...
    full_name='src.response.ResponseEnvelope',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name='response_code', full_name='src.response.ResponseEnvelope.response_code', index=0,
        ...
        _descriptor.FieldDescriptor(
            name='type', full_name='src.response.ResponseEnvelope.type', index=1,
            ...
            serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
        _descriptor.FieldDescriptor(
            name='application_message_id', full_name='src.response.ResponseEnvelope.application_message_id',
            index=2,
            ...
            serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
        _descriptor.FieldDescriptor(
            name='message_id', full_name='src.response.ResponseEnvelope.message_id', index=3,
            ...
            serialized_options=None, file=DESCRIPTOR, create_key=_descriptor._internal_create_key),
        _descriptor.FieldDescriptor(
            name='timestamp', full_name='src.response.ResponseEnvelope.timestamp', index=4,
...
_RESPONSEPAYLOADWRAPPER = _descriptor.Descriptor(
    ...
    full_name='src.response.ResponsePayloadWrapper',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name='details', full_name='src.response.ResponsePayloadWrapper.details', index=0,
...
ResponseEnvelope = _reflection.GeneratedProtocolMessageType('ResponseEnvelope', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:src.response.ResponseEnvelope)
})
...
ResponsePayloadWrapper = _reflection.GeneratedProtocolMessageType('ResponsePayloadWrapper', (_message.Message,), {
    ...
    '__module__': 'messaging.response.response_pb2'
    # @@protoc_insertion_point(class_scope:src.response.ResponsePayloadWrapper)
})
