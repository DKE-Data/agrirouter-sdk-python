from src.generated.cloud_provider_integration.cloud_virtualized_app_registration_pb2 import OnboardingRequest, \
    OffboardingRequest
...
from src.messaging.services.messaging import AbstractService
