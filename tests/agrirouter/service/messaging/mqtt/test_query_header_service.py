...
from agrirouter.service.messaging.message_sending import FeedDeleteService, QueryHeaderService, SendMessageService
...
from agrirouter.service.parameter.messaging import FeedDeleteParameters, QueryHeaderParameters, SendMessageParameters
...
class TestQueryHeaderService(unittest.TestCase):
    ...
    def _incomplete_attributes_callback(self, client, userdata, msg):
        """
