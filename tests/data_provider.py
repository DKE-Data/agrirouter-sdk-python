...
class DataProvider:
    ...
    def read_base64_encoded_large_bmp():
        large_bmp_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), DataProvider._CONTENT_DIR, 'large_bmp.bmp')
    ...
    def read_base64_encoded_small_shape():
        small_shape_zip_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), DataProvider._CONTENT_DIR, 'small_shape.zip')
    ...
    def read_base64_encoded_large_shape():
        large_shape_zip_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), DataProvider._CONTENT_DIR, 'large_shape.zip')
    ...
    def read_base64_encoded_small_task_data():
        small_task_data_zip_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), DataProvider._CONTENT_DIR, 'small_taskdata.zip')
