...
class TestCreateMessageSenderAndRecipient:
    ...
    def test_create_message_sender_with_pem(onboarding_process_fixture):
        sender_onboard_response = onboarding_process_fixture(
        ...
        TestCreateMessageSenderAndRecipient._enable_capabilities_via_mqtt(onboard_response=sender_onboard_response,
    ...
    def test_create_message_recipient_with_pem(onboarding_process_fixture):
        recipient_onboard_response = onboarding_process_fixture(
        ...
        OnboardResponseIntegrationService.save(Identifier.MQTT_MESSAGE_RECIPIENT[Identifier.PATH], recipient_onboard_response)

        TestCreateMessageSenderAndRecipient._enable_capabilities_via_mqtt(onboard_response=recipient_onboard_response,
                                                                          callback=TestCreateMessageSenderAndRecipient._on_message_callback)
